...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func configIFlySpeech(){
        ...
        let initString = "appid=53c35b10,timeout=20000";
        
        IFlySpeechUtility.createUtility(initString)
        
        IFlySetting.setLogFile(LOG_LEVEL.VL_NONE)
        ...
        IFlySpeechSynthesizer.sharedInstance().setParameter("", forKey: IFlySpeechConstant.TTS_AUDIO_PATH())
